...
public class BeanParseInit implements BeanDefinitionParser {

	private static final String ANNOTATION_POST_PROCESSOR_BEAN_NAME = BeanParseInit.class.getPackage().getName() + ".BeanParseInit";
	private static final String EVENT_REGISTRY_BEAN_NAME = BeanParseInit.class.getPackage().getName() + ".internalEventRegistry";
	...
	private RuntimeBeanReference initializeAnnotationPostProcessor( Element element, ParserContext parserContext, Object source, RuntimeBeanReference eventRegistryReference) {
		final RootBeanDefinition annotationPostProcessor = new RootBeanDefinition(InitializationBeanProcess.class);
